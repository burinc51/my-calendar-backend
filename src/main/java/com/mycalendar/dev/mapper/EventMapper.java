...
public class EventMapper {
    ...
    public static EventResponse mapToDto(Event event) {
        return EventResponse.builder()
                ...
                .startDate(formatSafe(event.getStartDate(), DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss")))
                .endDate(formatSafe(event.getEndDate(), DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss")))
                .location(event.getLocation())
                .latitude(event.getLatitude())
                .longitude(event.getLongitude())
                .notificationTime(formatSafe(event.getNotificationTime(), DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss")))
                .notificationType(event.getNotificationType())
                .remindBeforeValue(event.getRemindBeforeValue())
                .remindBeforeUnit(event.getRemindBeforeUnit())
                .remindBeforeMinutes(event.getRemindBeforeMinutes())
                .repeatType(event.getRepeatType())
                .repeatUntil(formatSafe(event.getRepeatUntil(), DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss")))
                .repeatInterval(event.getRepeatInterval())
                ...
                .icon(event.getGroup().getIcon())
                .groupColor(event.getGroup().getColor())
                .bg(event.getGroup().getBg())
            ...
            EventResponse e = map.computeIfAbsent(eventId, id ->
                    EventResponse.builder()
                            ...
                            .startDate(Optional.ofNullable(getValue(r, 3, LocalDateTime.class))
                                    .map(d -> d.format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss")))
                                    .orElse(null))
        ...
        for (EventProjection r : rows) {
            ...
            EventResponse e = map.computeIfAbsent(eventId, id ->
                    EventResponse.builder()
                            ...
                            .remindBeforeValue(r.getRemindBeforeValue())
                            .remindBeforeUnit(r.getRemindBeforeUnit())
                            ...
                            .repeatInterval(r.getRepeatInterval())
